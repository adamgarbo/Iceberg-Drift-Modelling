...
username_cmems = 'agarbo'
password_cmems = 'sC#SrdD8JiZB9M_'
...
local_storage_directory_name = 'Desktop/cmems'
...
for key, value in dict_id.items():
    ...
    while (date_start <= date_end):
        ...
        fic_cmd = pre_fic_cmd + key + "_" + date_end_cmd.strftime("%Y-%m") + "_" + var_name + ".nc"
        ficout = pre_name + key + "_" + date_end_cmd.strftime("%Y-%m") + "_" + var_name + ".nc"
